...
<nav class="main-header navbar navbar-expand navbar-gray-dark">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{!! route('admin.dashboard') !!}" class="nav-link text-light">Home</a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <form class="form-inline ml-3">
            <div class="input-group input-group-sm bg-gradient-blue">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="{{ asset('backend') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
