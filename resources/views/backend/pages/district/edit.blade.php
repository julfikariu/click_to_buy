            ...
            <div class="row">
                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="card card-navy">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.division.update', $district->id) }}" method="post"
                            ...
                            <!-- .card-body -->
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="name" name="name" value="{!! $district->name !!}" >
                                    </div>
                                ...
                                <button type="submit" class="btn btn-success float-right">Update Districts</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
