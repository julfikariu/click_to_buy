...
<footer class="page-footer text-center text-md-left stylish-color-dark pt-0">
    ...
    <div class="container mt-5 mb-4 text-center text-md-left">
        <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
                <h6 class="text-uppercase font-weight-bold"><strong>Click To Buy</strong></h6>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p><a href="#!">All Mobile</a></p>
                <p><a href="#!">All Laptop</a></p>
                <p><a href="#!">Brand Prodcts</a></p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3">
                ...
                <hr class="blue mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p><i class="fas fa-home mr-3"></i> Kushtia , NS , 4022</p>
                <p><i class="fas fa-envelope mr-3"></i> contact@example.com</p>
                <p><i class="fas fa-phone mr-3"></i> + 019 234 567 88</p>
                <p><i class="fas fa-print mr-3"></i> + 013 234 567 89</p>
            </div>
            <!--/.Fourth column-->
    ...
    <div class="footer-copyright py-3 text-center">
        <div class="container-fluid">
            © 2019 Copyright: <a href="https://clicktobuy.com" target="_blank"> ClickToBuy.com </a>
        </div>
    </div>
    <!--/.Copyright -->
