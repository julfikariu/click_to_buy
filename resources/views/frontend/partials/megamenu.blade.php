        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent1">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown mega-dropdown active">
                    <a class="nav-link dropdown-toggle  no-caret" id="navbarDropdownMenuLink1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">All Category</a>
                            ...
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-5 mb-4">
                                ...
                                <ul class="caret-style pl-0">
                                    @foreach( App\Models\Category::orderBy('name','asc')->where('parent_id', null)->get() as $parent)
                                        <li class="">
                                            <a class="dark-grey-text font-small menu-item mb-0">
                                                <img class="mr-1" src="{{ asset('images/categories/'.$parent->image) }}" alt="" width="50" height="30">
                                                {{ $parent->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="row mx-md-4 mx-1">
                            <div class="col-md-12 col-lg-4 sub-menu my-lg-5 mt-5 mb-4">
                                ...
                                <div class="view overlay mb-3 z-depth-1">
                                    <img src="images/products/9.jpg" class="img-fluid" alt="First sample image">
                    ...
                    <div class="dropdown-menu mega-menu v-2 row z-depth-1 white" aria-labelledby="navbarDropdownMenuLink1">
                        <div class="row mx-md-4 mx-1">
                            ...
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-md-5 mt-4 mb-4">
                                ...
                                <!--Featured image-->
                                <div class="view overlay mb-3 z-depth-1">
                                    <img src="images/img43.jpg" class="img-fluid" alt="First sample image">
                                    <div class="mask flex-center rgba-white-slight">
                                        <p></p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-4 mb-4">
                                ...
                                <!--Featured image-->
                                <div class="view overlay mb-3 z-depth-1">
                                    <img src="images/products/6.jpg" class="img-fluid" alt="First sample image">
                                    <div class="mask flex-center rgba-white-slight">
                                        <p></p>
                                    </div>
                                </div>
